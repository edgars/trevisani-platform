    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-1.5">
            ...
            <Select
              value={tipo}
              onValueChange={(v) => { setTipo(v as TipoVeiculo); setMarca(""); setModelo(""); }}
            >
          ...
          <div className="space-y-1.5">
            ...
            <Select name="anoFabricacao" required defaultValue={String(veiculo?.anoFabricacao ?? "")}>
          ...
          <div className="space-y-1.5">
            ...
            <Select name="anoModelo" required defaultValue={String(veiculo?.anoModelo ?? "")}>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-1.5">
            <Label>Cor</Label>
            <Select name="cor" defaultValue={veiculo?.cor ?? ""}>
          ...
          <div className="space-y-1.5">
            ...
            <Select name="categoria" defaultValue={veiculo?.categoria ?? ""}>
          ...
          <div className="space-y-1.5">
            ...
            <Select name="combustivel" defaultValue={veiculo?.combustivel ?? ""}>
          ...
          <div className="space-y-1.5">
            <Label>Câmbio</Label>
            <Select name="cambio" defaultValue={veiculo?.cambio ?? ""}>
          ...
          <div className="space-y-1.5">
            ...
            <Input id="kmAtual" name="kmAtual" type="number" min={0}
              placeholder="Ex: 45000" defaultValue={veiculo?.kmAtual ?? ""} />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-1.5">
            ...
            <Input id="placa" name="placa" placeholder="ABC-1D23"
              className="uppercase" maxLength={8} defaultValue={veiculo?.placa ?? ""} />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="renavam">RENAVAM</Label>
            <Input id="renavam" name="renavam" placeholder="00000000000"
              maxLength={11} defaultValue={veiculo?.renavam ?? ""} />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="chassi">Chassi (VIN)</Label>
            <Input id="chassi" name="chassi" placeholder="9BWZZZ377VT004251"
              maxLength={17} className="uppercase" defaultValue={veiculo?.chassi ?? ""} />
          </div>
          <div className="space-y-1.5 sm:col-span-2 lg:col-span-3">
            <Label htmlFor="situacaoDocumental">Situação documental</Label>
            <Input id="situacaoDocumental" name="situacaoDocumental"
              placeholder="Ex: Regular, Débitos de IPVA, Restrição financeira..."
              defaultValue={veiculo?.situacaoDocumental ?? ""} />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-1.5">
            <Label>Origem</Label>
            <Select name="origem" defaultValue={veiculo?.origem ?? "COMPRA"}>
              <SelectTrigger><SelectValue /></SelectTrigger>
              <SelectContent>
          ...
          {fornecedores.length > 0 && (
            <div className="space-y-1.5">
              ...
              <Select name="fornecedorId" defaultValue={veiculo?.fornecedorId ?? ""}>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="precoCusto" name="precoCusto" className="pl-9" placeholder="0,00"
                value={precoCusto} onChange={(e) => setPrecoCusto(formatBRL(e.target.value))}
                inputMode="numeric" />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="precoVenda" name="precoVenda" className="pl-9" placeholder="0,00"
                value={precoVenda} onChange={(e) => setPrecoVenda(formatBRL(e.target.value))}
                inputMode="numeric" />
            </div>
          </div>
